              ...
              <Card className="bg-white border-none shadow-md">
                <CardContent className="pt-6">
                  <div className="flex flex-col gap-4">
                    ...
                    <p className="text-gray-600 italic">
                      "Acredito que a metodologia personalizada, que busca entender quais são os desafios de cada pessoa
                      é o maior diferencial. Nós conseguimos mapear as minhas fraquezas e necessidades para trabalhar e
                      elas deixarem de atrapalhar meu cotidiano."
                    </p>
                    <div className="flex items-center gap-4 pt-4">
                      <div className="rounded-full bg-gray-200 p-1">
                        <Image
